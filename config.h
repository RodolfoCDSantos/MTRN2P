...
/* Define if a curses library available */
...
/* Define if gtk+ library available */
#define HAVE_GTK 1

/* Define if gtk+-3.0 library available */
#define HAVE_GTK3 1

/* Define to 1 if you have the <inttypes.h> header file. */
#define HAVE_INTTYPES_H 1

/* Define when ipinfo lookups are in use */
#define HAVE_IPINFO 1

/* Define if jansson library available */
/* #undef HAVE_JANSSON */
